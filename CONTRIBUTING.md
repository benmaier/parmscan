...
When contributing to this repository, please first discuss the change you wish to make via an [issue](https://github.com/benmaier/parmscan/issues/new).

Please note we have a [code of conduct](https://github.com/benmaier/parmscan/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
3. Increase the version number in [parmscan/metadata.py](https://github.com/benmaier/parmscan/blob/master/parmscan/metadata.py) and the README.md to the new version that this
